...
Culture is an important tool for tourism and urban development. According to Mayor of London, 4 out of 5 travellers indicated ‘culture’ as their main reason for visiting London, contributing £52 billion each year to London’s economy (n.d.). London’s varied cultural offerings constitutes of world class destinations such as the Buckingham Palace, the West End and internationally acclaimed museums. Not only that, London is also at the heart of emergent culture, with a vibrant music scene, night life, and diverse culture – a hotbed for creativity. With the rise of Airbnb, the distribution of travel accommodations has dispersed from traditionally central London, towards the periphery of the city where emergent are located. This brief explores how Airbnb operations interact with London’s cultural infrastructure and its hotel industry, with aims to suggest regulatory policies that allows residents to benefit from Airbnb, control gentrification, whilst protecting the hotel industry.

### Airbnb in London
Airbnb brands itself as a tool for the sharing economy, where property owners are given the opportunity to let temporarily vacant rooms or properties for short-term stays. Airbnb has proven to be beneficial for residents to temporarily let out their homes to visitors, providing an alternative source of income as well as accumulating the tourist dollar in the local area (Henama, 2018). Study based in Texas found a 1% increase in Airbnb reviews in an area is associated with a 0.011% increase in restaurant revenue (Basuroy et al, 2020). However, the digital platform has also been heavily criticised for its impact on accelerating gentrification. According to studies, this phenomenon is largely driven by the increasingly professionalisation of the platform, which is also continuously contributing to London's affordability crisis (Wachsmuth and Weisler 2018; Harris 2018; Lee 2016). Professional hosts - i.e. those with more than one Airbnb listing, often buy up existing housing stock in culturally desirable areas to let out on Airbnb, earning up to 16.9% higher daily revenue on their properties than non-professional hosts (Li et al. 2015). This does not only reduce available housing stock for permanent residents, it also drives up prices of local properties and goods and services, further displacing local Londoners. This brief seeks to a balance solution to reap the benefits of the sharing economy, without displacing incumbent residents. Many scholar have found that the benefits of Airbnb tend to subsides after a certain threshold (Fang, Ye, Law (2015)). This brief aims to identify areas where Airbnb’s operations is still making a positive impact on the local economy, and where intervention needs to be implemented to avoid displacement and an Airbnb monopoly within the tourist accommodation sector. 

###Airbnb and Hotels
The digital platform has significantly disrupted the hotel industry since it entered the market in 2015. While hotels were one of the few options for travel accommodations, Airbnb has now taken a larger scale of the market by providing a wide variety of dwelling types, cheaper rental prices and a sense of authenticity. Studies have shown that the Hotel industry has lost XXX in profit since the dawn of Airbnb. Some have found 1% increase in Airbnb listing has led to a 0.04% decrease in hotel revenue (Zervas, Proserpio, & Byers, 2016). From a regulatory perspective, the well monitored, well taxed, established hotel industries, often located in the culturally dense areas needs to be protected. However, some might argue the opposite. As studies found, Airbnb and hotels fulfil a different type of accommodation needs, such that they do not directly compete. 
